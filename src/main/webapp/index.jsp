...
<div class="container">
    ...
    <p>
        ...
        <strong>Apache Tomcat</strong> and built using <strong>JENKINS using Maven and enabled webhooks as well and now automated this process testing again </strong>.
    </p>
