...
<div class="container">
    ...
    <p>
        ...
        <strong>Apache Tomcat</strong> and built using <strong>JENKINS using Maven and enabled webhooks as well and now automated this process and configured the jfraog as well </strong>.
    </p>
    ...
    <div class="info">
        ...
        <p>Configured end to end pipeline job succefully...dxcfgvuh </p>
    </div>
